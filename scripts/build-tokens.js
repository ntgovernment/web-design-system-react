...
try {
  ...
  console.log(
    `  ✓ Generated src/themes/common.css (${totalCommon} shared variables)`,
  );
} catch (error) {
...
try {
  ...
  if (gridTokens.length > 0) {
    ...
    console.log(
      `  ✓ Generated src/themes/grid.css (${gridTokens.length} variables)`,
    );
  } else {
...
try {
  ...
  if (typographyTokens.length > 0) {
    ...
    console.log(
      `  ✓ Generated src/themes/typography.css (${typographyTokens.length} variables)`,
    );
  } else {
...
try {
  ...
  if (typographyTokens.length > 0) {
    ...
    const literalsPath = join(rootDir, "src/themes/typography-literals.css");
    writeFileSync(literalsPath, literalsCSS, "utf-8");

    const literalCount = (literalsCSS.match(/--literal-text-transform-/g) || [])
      .length;
    console.log(
      `  ✓ Generated src/themes/typography-literals.css (${literalCount} literal values)`,
    );
  } else {
...
try {
  ...
  const ntgPath = join(rootDir, "src/themes/theme-ntg.css");
  writeFileSync(ntgPath, ntgResult.css, "utf-8");

  console.log("  ✓ Generated src/themes/theme-ntg.css");
  ...
  const baseVarsPath = join(rootDir, "src/themes/base-variables.css");
  writeFileSync(baseVarsPath, baseVarsCSS, "utf-8");

  console.log(
    `  ✓ Generated src/themes/base-variables.css (${semanticVars.length} semantic variables)`,
  );
} catch (error) {
...
try {
  ...
  const centralPath = join(rootDir, "src/themes/theme-central.css");
  writeFileSync(centralPath, centralResult.css, "utf-8");

  console.log("  ✓ Generated src/themes/theme-central.css");
} catch (error) {
...
try {
  ...
  const ntgBootstrapPath = join(rootDir, "src/themes/typography-ntg.css");
  writeFileSync(ntgBootstrapPath, ntgBootstrapCSS, "utf-8");
  console.log("  ✓ Generated src/themes/typography-ntg.css");
  ...
  const centralBootstrapPath = join(
    rootDir,
    "src/themes/typography-central.css",
  );
  writeFileSync(centralBootstrapPath, centralBootstrapCSS, "utf-8");
  console.log("  ✓ Generated src/themes/typography-central.css");
} catch (error) {
  console.error(
...
console.log("  - src/themes/grid.css (Bootstrap grid)");
console.log("  - src/themes/typography.css (theme-agnostic fonts)");
console.log(
  "  - src/themes/typography-literals.css (literal values for text-transform)",
);
console.log(
  "  - src/themes/base-variables.css (unprefixed semantic variables)",
);
console.log("  - src/themes/theme-ntg.css (NT.GOV.AU theme)");
console.log("  - src/themes/theme-central.css (NTG Central theme)");
console.log("  - src/themes/typography-ntg.css (Bootstrap overrides for NTG)");
console.log(
  "  - src/themes/typography-central.css (Bootstrap overrides for Central)",
);
console.log(
