import{j as t}from"./iframe-lBeUY_a6.js";const i=({variant:a="default",label:n,className:e,...r})=>{const l=`tag tag-${a}${e?` ${e}`:""}`;return t.jsx("span",{className:l,...r,children:n})};i.__docgenInfo={description:`Tag component for categorizing and differentiating content.\r
