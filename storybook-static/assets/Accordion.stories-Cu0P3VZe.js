import{r as w,j as e}from"./iframe-CJcOhIH1.js";import"./preload-helper-Dc5Yqcnt.js";const x=({items:r,showOpenCloseAll:O=!0,alwaysOpen:y=!1,theme:T,className:S=""})=>{const[C,j]=w.useState(new Set(r.filter(t=>t.defaultOpen).map(t=>t.id))),k=w.useCallback(t=>{j(o=>{const i=new Set(o);return i.has(t)?i.delete(t):(y||i.clear(),i.add(t)),i})},[y]),I=w.useCallback(()=>{j(new Set(r.map(t=>t.id)))},[r]),N=w.useCallback(()=>{j(new Set)},[]),v=C.size===r.length&&r.length>0,b=`accordion-${Math.random().toString(36).substr(2,9)}`;return e.jsxs("div",{className:S,"data-theme":T,children:[O&&r.length>0&&e.jsx("div",{className:"accordion-controls",children:e.jsx("button",{type:"button",className:"accordion-controls-link",onClick:v?N:I,"aria-label":v?"Close all accordions":"Open all accordions",children:v?"Close all":"Open all"})}),e.jsx("div",{className:"accordion",id:b,children:r.map(t=>{const o=C.has(t.id),i=`${b}-heading-${t.id}`,A=`${b}-collapse-${t.id}`;return e.jsxs("div",{className:"accordion-item",children:[e.jsx("h2",{className:"accordion-header",id:i,children:e.jsxs("button",{className:`accordion-button${o?"":" collapsed"}`,type:"button",onClick:()=>k(t.id),"aria-expanded":o,"aria-controls":A,children:[t.showIcon&&t.icon&&e.jsx("span",{className:"accordion-button-icon","aria-hidden":"true",children:e.jsx("i",{className:t.icon})}),t.title]})}),e.jsx("div",{id:A,className:`accordion-collapse collapse${o?" show":""}`,"aria-labelledby":i,"data-bs-parent":y?void 0:`#${b}`,children:e.jsx("div",{className:"accordion-body",children:t.content})})]},t.id)})})]})};x.__docgenInfo={description:`Accordion Component\r
\r
...
\`\`\``,methods:[],displayName:"Accordion",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"AccordionItemProps"}],raw:"AccordionItemProps[]"},description:"Array of accordion items to display"},showOpenCloseAll:{required:!1,tsType:{name:"boolean"},description:'Whether to show "Open/Close all" controls',defaultValue:{value:"true",computed:!1}},alwaysOpen:{required:!1,tsType:{name:"boolean"},description:"Allow multiple items to be open simultaneously",defaultValue:{value:"false",computed:!1}},theme:{required:!1,tsType:{name:"union",raw:'"ntg" | "central"',elements:[{name:"literal",value:'"ntg"'},{name:"literal",value:'"central"'}]},description:"Theme variant"},className:{required:!1,tsType:{name:"string"},description:"Additional CSS class names",defaultValue:{value:'""',computed:!1}}}};const U={title:"Components/Accordion",component:x,parameters:{layout:"padded",docs:{description:{component:"A collapsable and expandable panel of content that gives the user choice over what they see. Accordions allow users to show and hide related sections of content quickly. They should be used sparingly - if users need most of the content on a page, it should be formatted in plain text, not hidden in an accordion."}}},tags:["autodocs"],argTypes:{items:{description:"Array of accordion items to display",control:{type:"object"}},showOpenCloseAll:{control:"boolean",description:'Show "Open/Close all" link at top right',table:{defaultValue:{summary:"true"}}},alwaysOpen:{control:"boolean",description:"Allow multiple accordions to be open simultaneously",table:{defaultValue:{summary:"false"}}},theme:{control:"select",options:["ntg","central"],description:"Theme variant (ntg for external, central for intranet)"},className:{control:"text",description:"Additional CSS class names"}}},n={item1:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["This is the first item's accordion body. It demonstrates standard text content with ",e.jsx("a",{href:"#",children:"inline links"})," and"," ",e.jsx("strong",{children:"text formatting"}),"."]}),e.jsxs("ul",{children:[e.jsx("li",{children:"Bullet point one with relevant information"}),e.jsx("li",{children:"Bullet point two with additional details"}),e.jsx("li",{children:"Bullet point three with supporting context"})]})]}),item2:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"The second accordion contains information relevant to a specific subset of users. This helps keep the main page uncluttered while still providing access to important details."}),e.jsx("p",{children:"Multiple paragraphs can be included with appropriate spacing and formatting to improve readability."})]}),item3:e.jsxs(e.Fragment,{children:[e.jsx("h4",{style:{marginTop:0},children:"Subheading within accordion"}),e.jsx("p",{children:"Accordions can contain various content types including headings, paragraphs, lists, and links to other resources."}),e.jsxs("p",{children:["Learn more about ",e.jsx("a",{href:"#",children:"related topics"})," or visit the"," ",e.jsx("a",{href:"#",children:"documentation page"})," for additional guidance."]})]}),item4:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"This section provides additional context and information that supplements the main page content."}),e.jsx("p",{children:"Use accordions to organize related information into logical, digestible sections."})]})},a={args:{items:[{id:"accordion-1",title:"Grant categories and funding amounts",content:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"The Territory Grants Program offers funding across three categories to support community organisations and small businesses."}),e.jsxs("ul",{children:[e.jsx("li",{children:"Community development grants — up to $25,000"}),e.jsx("li",{children:"Infrastructure improvement grants — up to $50,000"}),e.jsx("li",{children:"Youth and education initiatives — up to $15,000"})]}),e.jsxs("p",{children:["Funding is available to eligible organisations operating within the Northern Territory."," ",e.jsx("a",{href:"#",children:"View the full program guidelines"}),"."]})]}),defaultOpen:!1},{id:"accordion-2",title:"Eligibility requirements",content:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"To be eligible for Territory Grants Program funding, applicants must meet the following criteria:"}),e.jsxs("ul",{children:[e.jsx("li",{children:"Registered as a not-for-profit, incorporated association or small business in the NT"}),e.jsx("li",{children:"ABN registered with current financial records available"}),e.jsx("li",{children:"No outstanding compliance obligations with NT Government agencies"})]}),e.jsx("p",{children:"Individual applicants and unincorporated groups are not eligible to apply directly. A fiscal sponsor arrangement may be available in some cases."})]}),defaultOpen:!1},{id:"accordion-3",title:"Application and assessment process",content:e.jsxs(e.Fragment,{children:[e.jsx("h4",{style:{marginTop:0},children:"Submitting your application"}),e.jsx("p",{children:"Applications are submitted online through the Grants Management Portal. You will need to create an account and complete all required fields before submitting."}),e.jsxs("p",{children:["Applications are assessed against the program criteria by an independent panel. Decisions are notified within 8 weeks of the round closing. See the ",e.jsx("a",{href:"#",children:"assessment criteria"})," for full details."]})]}),defaultOpen:!1}],showOpenCloseAll:!0,alwaysOpen:!1}},s={args:{items:[{id:"icon-1",title:"Licenses and permits",content:n.item1,icon:"fa-light fa-id-card",showIcon:!0},{id:"icon-2",title:"Business registration",content:n.item2,icon:"fa-light fa-briefcase",showIcon:!0},{id:"icon-3",title:"Tax obligations",content:n.item3,icon:"fa-light fa-file-invoice-dollar",showIcon:!0},{id:"icon-4",title:"Employment requirements",content:n.item4,icon:"fa-light fa-users",showIcon:!0}],showOpenCloseAll:!0,alwaysOpen:!1}},l={args:{items:[{id:"large-1",title:"Section 1: Overview",content:n.item1},{id:"large-2",title:"Section 2: Requirements",content:n.item2},{id:"large-3",title:"Section 3: Application process",content:n.item3},{id:"large-4",title:"Section 4: Supporting documents",content:n.item4},{id:"large-5",title:"Section 5: Fees and charges",content:n.item1},{id:"large-6",title:"Section 6: Assessment timeframes",content:n.item2}],showOpenCloseAll:!0,alwaysOpen:!1}},c={args:{items:[{id:"expanded-1",title:"Currently viewing this section",content:n.item1,defaultOpen:!0},{id:"expanded-2",title:"Additional information",content:n.item2,defaultOpen:!1},{id:"expanded-3",title:"Related resources",content:n.item3,defaultOpen:!1}],showOpenCloseAll:!0,alwaysOpen:!1}},d={parameters:{backgrounds:{default:"light"}},args:{items:[{id:"ntg-1",title:"Northern Territory services",content:n.item1,icon:"fa-light fa-landmark",showIcon:!0},{id:"ntg-2",title:"Community programs",content:n.item2,icon:"fa-light fa-people-group",showIcon:!0},{id:"ntg-3",title:"Contact information",content:n.item3,icon:"fa-light fa-phone",showIcon:!0}],theme:"ntg",showOpenCloseAll:!0,alwaysOpen:!1}},p={parameters:{backgrounds:{default:"light"}},args:{items:[{id:"central-1",title:"Staff resources",content:n.item1,icon:"fa-light fa-folder-open",showIcon:!0},{id:"central-2",title:"Policy documents",content:n.item2,icon:"fa-light fa-file-lines",showIcon:!0},{id:"central-3",title:"Training materials",content:n.item3,icon:"fa-light fa-graduation-cap",showIcon:!0}],theme:"central",showOpenCloseAll:!0,alwaysOpen:!1}},m={render:()=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"2rem"},children:[e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:"1rem",fontFamily:"Lato"},children:"NT.GOV.AU Theme"}),e.jsx(x,{items:[{id:"comp-ntg-1",title:"External website style",content:n.item1},{id:"comp-ntg-2",title:"Lato font family",content:n.item2},{id:"comp-ntg-3",title:"Ochre accent color",content:n.item3}],theme:"ntg",showOpenCloseAll:!0,alwaysOpen:!1})]}),e.jsxs("div",{children:[e.jsx("h3",{style:{marginBottom:"1rem",fontFamily:"Roboto"},children:"NTG Central Theme"}),e.jsx(x,{items:[{id:"comp-central-1",title:"Internal website style",content:n.item1},{id:"comp-central-2",title:"Roboto font family",content:n.item2},{id:"comp-central-3",title:"Green accent color",content:n.item3}],theme:"central",showOpenCloseAll:!0,alwaysOpen:!1})]})]})},u={parameters:{a11y:{config:{rules:[{id:"color-contrast",enabled:!0},{id:"aria-allowed-attr",enabled:!0},{id:"aria-required-attr",enabled:!0}]}}},args:{items:[{id:"a11y-1",title:"Keyboard navigation supported",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:["Use ",e.jsx("kbd",{children:"Tab"})," to navigate between accordion buttons."]}),e.jsxs("p",{children:["Use ",e.jsx("kbd",{children:"Enter"})," or ",e.jsx("kbd",{children:"Space"})," to expand/collapse."]}),e.jsx("p",{children:"All interactive elements are keyboard accessible."})]})},{id:"a11y-2",title:"Screen reader compatible",content:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"Proper ARIA attributes ensure screen reader compatibility:"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"aria-expanded"})," indicates open/closed state"]}),e.jsxs("li",{children:[e.jsx("code",{children:"aria-controls"})," links button to content panel"]}),e.jsxs("li",{children:[e.jsx("code",{children:"role"})," attributes provide semantic meaning"]})]})]})},{id:"a11y-3",title:"Focus indicators visible",content:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"Clear focus states help keyboard users navigate:"}),e.jsx("p",{children:"NTG theme uses ochre outline, Central theme uses green outline."}),e.jsx("p",{children:"Focus indicators meet WCAG 2.1 requirements for visibility."})]})}],showOpenCloseAll:!0,alwaysOpen:!1}},h={args:{items:[{id:"rich-1",title:"Multiple content types",content:e.jsxs(e.Fragment,{children:[e.jsx("h4",{style:{marginTop:0},children:"Subheading"}),e.jsxs("p",{children:["Paragraphs with ",e.jsx("strong",{children:"bold text"}),", ",e.jsx("em",{children:"italic text"}),", and ",e.jsx("a",{href:"#",children:"hyperlinks"}),"."]}),e.jsxs("ul",{children:[e.jsx("li",{children:"Unordered list item 1"}),e.jsxs("li",{children:["Unordered list item 2 with ",e.jsx("a",{href:"#",children:"a link"})]}),e.jsx("li",{children:"Unordered list item 3"})]})]})},{id:"rich-2",title:"Ordered lists and links",content:e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"Step-by-step instructions (though accordions should generally be avoided for stepped processes):"}),e.jsxs("ol",{children:[e.jsxs("li",{children:["First step with ",e.jsx("a",{href:"#",children:"relevant link"})]}),e.jsx("li",{children:"Second step with additional context"}),e.jsx("li",{children:"Third step completing the process"})]}),e.jsxs("p",{children:["For more information, visit the ",e.jsx("a",{href:"#",children:"help center"}),"."]})]})},{id:"rich-3",title:"Mixed formatting",content:e.jsxs(e.Fragment,{children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Important:"})," This section contains critical information."]}),e.jsxs("p",{children:["Additional context with ",e.jsx("a",{href:"#",children:"supporting documentation"})," ","and detailed explanations."]})]})}],showOpenCloseAll:!0,alwaysOpen:!1}},g={args:{items:[{id:"min-1",title:"First accordion in minimum group",content:n.item1},{id:"min-2",title:"Second accordion in minimum group",content:n.item2},{id:"min-3",title:"Third accordion in minimum group",content:n.item3}],showOpenCloseAll:!0,alwaysOpen:!1}},f={args:{items:[{id:"always-1",title:"First section (can stay open)",content:n.item1,defaultOpen:!0},{id:"always-2",title:"Second section (can stay open)",content:n.item2,defaultOpen:!0},{id:"always-3",title:"Third section (can stay open)",content:n.item3,defaultOpen:!1}],showOpenCloseAll:!0,alwaysOpen:!0}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    items: [{
      ...
      content: <>\r
            <p>\r
              The Territory Grants Program offers funding across three\r
              categories to support community organisations and small\r
              businesses.\r
            </p>\r
            <ul>\r
              <li>Community development grants — up to $25,000</li>\r
              <li>Infrastructure improvement grants — up to $50,000</li>\r
              <li>Youth and education initiatives — up to $15,000</li>\r
            </ul>\r
            <p>\r
              Funding is available to eligible organisations operating within\r
              the Northern Territory.{" "}\r
              <a href="#">View the full program guidelines</a>.\r
            </p>\r
          </>,
      defaultOpen: false
    }, {
      ...
      content: <>\r
            <p>\r
              To be eligible for Territory Grants Program funding, applicants\r
              must meet the following criteria:\r
            </p>\r
            <ul>\r
              <li>\r
                Registered as a not-for-profit, incorporated association or\r
                small business in the NT\r
              </li>\r
              <li>ABN registered with current financial records available</li>\r
              <li>\r
                No outstanding compliance obligations with NT Government\r
                agencies\r
              </li>\r
            </ul>\r
            <p>\r
              Individual applicants and unincorporated groups are not eligible\r
              to apply directly. A fiscal sponsor arrangement may be available\r
              in some cases.\r
            </p>\r
          </>,
      defaultOpen: false
      ...
      content: <>\r
            <h4 style={{
          marginTop: 0
        }}>Submitting your application</h4>\r
            <p>\r
              Applications are submitted online through the Grants Management\r
              Portal. You will need to create an account and complete all\r
              required fields before submitting.\r
            </p>\r
            <p>\r
              Applications are assessed against the program criteria by an\r
              independent panel. Decisions are notified within 8 weeks of the\r
              round closing. See the <a href="#">assessment criteria</a> for\r
              full details.\r
            </p>\r
          </>,
      defaultOpen: false
...
Note the different fonts (Lato vs Roboto) and accent colors (ochre vs green).`,...m.parameters?.docs?.description}}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  parameters: {
    a11y: {
      config: {
        rules: [{
...
}`,...u.parameters?.docs?.source},description:{story:`Accessibility demonstration showing keyboard navigation and screen reader support.\r
...
- All interactive elements are keyboard accessible`,...u.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  args: {
    items: [{
      id: "rich-1",
...
}`,...h.parameters?.docs?.source},description:{story:`Rich content example showing various content types within accordions.\r
Accordions can contain links, formatting, lists, and other standard HTML elements.\r
Avoid putting buttons or complex interactive components inside accordions.`,...h.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  args: {
    items: [{
      id: "min-1",
...
The "Open all" / "Close all" control is particularly useful in this mode.`,...f.parameters?.docs?.description}}};const R=["Default","WithIcons","LargeGroup","OneExpanded","ThemeNTG","ThemeCentral","ThemeComparison","Accessibility","RichContent","MinimumGroupSize","AlwaysOpen"];export{u as Accessibility,f as AlwaysOpen,a as Default,l as LargeGroup,g as MinimumGroupSize,c as OneExpanded,h as RichContent,p as ThemeCentral,m as ThemeComparison,d as ThemeNTG,s as WithIcons,R as __namedExportsOrder,U as default};
