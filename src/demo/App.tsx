    ...
    <>
      <Header
        ...
        navItems={[
          ...
          { label: "Contacts", href: "https://nt.gov.au/contacts" },
        ]}
        showSearch={true}
      ...
      <div className="container my-5">
        ...
        <section className="mb-5">
          ...
          <p className="text-muted mb-3">
            ...
            actions. Supports composition with Image, Tag, and Button
            components.
            <br />
        ...
        <section className="mb-5">
          <h2>Pills</h2>
          <p className="text-muted mb-3">
            Removable pill components for filters, selections, and tags. Click
            the (×) to remove.
          </p>
